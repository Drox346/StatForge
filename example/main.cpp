...
int main() {
    ...
    auto& spreadsheet = engine.spreadsheet();
    ...
    spreadsheet.createFormulaCell("flatLifeSubclass", "<subclass> == 0 ? 0 : <subclass> == 1 ? 100 : <subclass> == 2 ? 300 : 0");
    spreadsheet.createFormulaCell("flatLifeLevel", "<level> * <flatLifePerLevel>");
    spreadsheet.createAggregatorCell("flatLifeAggr", {"baselife", "flatLifeLevel", "flatLifeSubclass"});
